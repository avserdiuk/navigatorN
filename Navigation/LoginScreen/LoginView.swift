...
class LoginView: UIView {
    ...
    private func setupViews(){
        ...
        NSLayoutConstraint.activate([
            scrollView.topAnchor.constraint(equalTo: super.safeAreaLayoutGuide.topAnchor),
            ...
            stackView.leadingAnchor.constraint(equalTo: super.leadingAnchor, constant: 16),
            stackView.trailingAnchor.constraint(equalTo: super.trailingAnchor, constant: -16),
            stackView.heightAnchor.constraint(equalToConstant: 100),
            
            loginButton.heightAnchor.constraint(equalToConstant: 50),
            loginButton.topAnchor.constraint(equalTo: stackView.bottomAnchor, constant: 16),
            loginButton.leadingAnchor.constraint(equalTo: super.leadingAnchor, constant: 16),
            loginButton.trailingAnchor.constraint(equalTo: super.trailingAnchor, constant: -16)
